...
q_symbol q_symbol_create(const char *s) { return intern((char *)s, strlen(s)); }

q_symbol q_symbol_create_buffer(char *b, size_t len) { return intern(b, len); }

const char *q_symbol_string(q_symbol s) { return table[s]; }
